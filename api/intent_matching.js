  ...
  if (matchedIntent) {
    ...
    if (locale == "en-US") {
      ...
      if (cleanedIntentReq.endsWith(dateSearchStrA)) {
        // User is asking for the date in a specific location
        intentArg = cleanedIntentReq.substring(
          0,
          cleanedIntentReq.length - dateSearchStrA.length
        );
        return ASK_DATE_INTENT;
        ...
        intentArg = cleanedIntentReq.substring(
          0,
          cleanedIntentReq.length - timeSearchStrA.length
        );
        return ASK_TIME_INTENT;
        ...
        intentArg = cleanedIntentReq.substring(
          0,
          cleanedIntentReq.length - timeSearchStrB.length
        );
        return ASK_TIME_INTENT;
      }
    }
    ...
    if (intentArg != "") {
      ...
      if (formattedDate != null) {
        if (locale == "en-US") {
          ...
          retFulfillment =
            "Aujourd'hui c'est le " + formattedDate + " " + intentArg + ".";
        } else if (locale == "ja-JP") {
        ...
        if (locale == "en-US") {
          ...
          retFulfillment =
            "Je ne sais pas quelle date c'est " + intentArg + ".";
        } else if (locale == "ja-JP") {
    ...
    if (intentArg != "") {
      ...
      if (formattedDate != null) {
        ...
        if (locale == "en-US") {
          ...
          retFulfillment =
            "Je ne sais pas quelle heure il est " + intentArg + ".";
        } else if (locale == "ja-JP") {
