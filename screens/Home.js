...
const Home = () => {
    ...
    function renderIncomingExpensesTitle() {
        return (
            <View style={{ height: 70, backgroundColor: COLORS.lightGray2, padding: SIZES.padding }}>
                {/* Title */}
                <Text style={{ ...FONTS.h3, color: COLORS.primary }}>PREVENTION MEASURES</Text>
            ...
            return (
                <View  style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ position: 'absolute', top: '42%', left: "42%" }}>
                        ...
                        <Text style={{ ...FONTS.body3, textAlign: 'center' }}>Measures</Text>
                    </View>
                </View>
